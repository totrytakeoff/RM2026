 ...
 * @date 2026-07-22
 * @note 修改参数后必须重新编译；完整说明见 docs/motor/infantry_control_parameter_reference.md
 *
 * 参数标记：
...
#define INFANTRY_TUNING_TELEMETRY_ENABLE            1U /* [核心-调试] 独立二进制遥测总开关 */
#endif
#define INFANTRY_TUNING_UART_PORT                    6U      /* [固定] 当前使用 USART6 */
#define INFANTRY_TUNING_UART_BAUDRATE                115200U /* [固定] VOFA+ 波特率 */
#define INFANTRY_TUNING_TASK_PERIOD_MS               20U     /* [核心-调试] 50 Hz 采样周期 */
...
#define INFANTRY_CPU_FREQUENCY_MHZ      168U   /* [固定] STM32F407 主频 */
#define INFANTRY_IMU_INIT_TIMEOUT_MS    15000U /* [保护] INS 初始化最长等待时间 */

/* FreeRTOS迁移阶段任务周期：控制环保持minimal基线，快环独立调度。 */
#define INFANTRY_INS_TASK_PERIOD_MS         1U  /* [核心-时序] IMU 更新周期，1 kHz */
#define INFANTRY_MOTOR_TASK_PERIOD_MS       5U  /* [核心-时序] DJI 电机闭环周期，200 Hz */
#define INFANTRY_HEALTH_TASK_PERIOD_MS      5U  /* [保护] 守护与任务健康检查周期 */
#define INFANTRY_DIAGNOSTICS_TASK_PERIOD_MS 10U /* [固定] 文本诊断任务调度周期 */

/* 20 ms 控制任务失活时，5 ms 电机任务独立执行的命令租约。 */
#define INFANTRY_MOTOR_COMMAND_TIMEOUT_MS    100U /* [保护] 应用 100 ms 未续命则电机清零 */
...
#define INFANTRY_TASK_STARTUP_GRACE_MS           100U /* [保护] 调度启动宽限 */
#define INFANTRY_TASK_HEARTBEAT_PERIODS            4U /* [保护] 允许丢失的任务周期数 */
#define INFANTRY_TASK_DEADLINE_TOLERANCE_PERCENT  25U /* [保护] 单周期超期容差 */
#define INFANTRY_TASK_MAX_CONSECUTIVE_OVERRUNS     3U /* [保护] 连续超期判故障次数 */
#define INFANTRY_TASK_MIN_STACK_FREE_WORDS        64U /* [保护] 最低剩余栈，单位 word */
#define INFANTRY_TASK_STACK_SAMPLE_INTERVAL      100U /* [固定] 栈余量抽样间隔 */

/* Only the health task refreshes IWDG; a stalled scheduler or critical task resets. */
#define INFANTRY_HARDWARE_WATCHDOG_TIMEOUT_MS   1000U /* [保护] IWDG 复位时间 */

/*
 * 调试阶段安全策略：SA 使用直接电平门；单个电机掉线只隔离该电机并报警，
 * 不连带关闭其余在线执行器。遥控失联、初始化失败、INS/任务故障仍会停机。
 */
#define INFANTRY_SAFETY_REQUIRE_EXPLICIT_REARM  0U /* [核心-安全] 0=SA 电平直接放行 */
#define INFANTRY_SAFETY_GATE_ON_MOTOR_HEALTH    0U /* [核心-安全] 0=掉线只报警/隔离 */
