...
static const InfantryGimbalAxisStateConfig config = {
...
static void TestNormalTransition(void)
{
    ...
    CHECK(InfantryGimbalAxisState_Update(
...
{
    InfantryGimbalAxisState state;
    InfantryGimbalAxisStateConfig invalid = config;
...
int main(void)
{
    ...
    puts("infantry_gimbal_axis_state_test: PASS");
    return 0;
}
