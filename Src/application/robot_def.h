...
/* 视觉功能开关(需要与上面的 VISION_USE_VCP/UART 配合使用) */
// #define VISION_ENABLE   // 开启视觉功能(需先确保串口不冲突)
...
#define ROBOT_CMD_UART_DATALINK_HANDLE huart6
#define ROBOT_CMD_UART_VISION_HANDLE huart1
#define CHASSIS_REFEREE_UART_HANDLE huart1
...
#define CMD_ET08_CHASSIS_VEL_SCALE 20.0f
#define CMD_ET08_CHASSIS_WZ_SCALE 47.0f
...
#define CMD_ET08_CHASSIS_VX_SLEW_PER_MS 0.20f
#define CMD_ET08_CHASSIS_VY_SLEW_PER_MS 0.20f
#define CMD_ET08_CHASSIS_WZ_SLEW_PER_MS 0.45f
...
/* app安全超时参数 */
#define APP_CMD_TIMEOUT_MS 100.0f
...
#define SHOOT_FRICTION_SPEED_PID_KP 10.0f
#define SHOOT_FRICTION_SPEED_PID_KI 0.0f
#define SHOOT_FRICTION_SPEED_PID_KD 0.0f
#define SHOOT_FRICTION_SPEED_PID_IMPROVE PID_Trapezoid_Intergral | PID_Integral_Limit | PID_Derivative_On_Measurement
#define SHOOT_FRICTION_SPEED_PID_INTEGRAL_LIMIT 3000.0f
...
#define SHOOT_FRICTION_CURRENT_PID_IMPROVE PID_Trapezoid_Intergral | PID_Integral_Limit | PID_Derivative_On_Measurement
#define SHOOT_FRICTION_CURRENT_PID_INTEGRAL_LIMIT 3000.0f
...
#define SHOOT_LOADER_ANGLE_PID_KP 3.5f
#define SHOOT_LOADER_ANGLE_PID_KI 0.0f
#define SHOOT_LOADER_ANGLE_PID_KD 0.5f
#define SHOOT_LOADER_ANGLE_PID_IMPROVE PID_Trapezoid_Intergral | PID_Integral_Limit
#define SHOOT_LOADER_ANGLE_PID_MAX_OUT 30000.0f
#define SHOOT_LOADER_SPEED_PID_KP 4.5f
#define SHOOT_LOADER_SPEED_PID_KI 0.0f
#define SHOOT_LOADER_SPEED_PID_KD 0.2f
#define SHOOT_LOADER_SPEED_PID_IMPROVE PID_Trapezoid_Intergral | PID_Integral_Limit | PID_Derivative_On_Measurement
#define SHOOT_LOADER_SPEED_PID_INTEGRAL_LIMIT 3000.0f
#define SHOOT_LOADER_SPEED_PID_MAX_OUT 22000.0f
#define SHOOT_LOADER_CURRENT_PID_KP 0.6f
#define SHOOT_LOADER_CURRENT_PID_KI 0.0f
#define SHOOT_LOADER_CURRENT_PID_KD 0.0f
#define SHOOT_LOADER_CURRENT_PID_IMPROVE PID_Trapezoid_Intergral | PID_Integral_Limit | PID_Derivative_On_Measurement
#define SHOOT_LOADER_CURRENT_PID_INTEGRAL_LIMIT 3000.0f
#define SHOOT_LOADER_CURRENT_PID_MAX_OUT 28000.0f
#define SHOOT_LOADER_INIT_OUTER_LOOP SPEED_LOOP
#define SHOOT_LOADER_INIT_CLOSE_LOOP (SPEED_LOOP | CURRENT_LOOP)
...
#define GIMBAL_YAW_SPEED_PID_KI 40.0f
...
#define CHASSIS_MOTOR_LF_ID 2u
#define CHASSIS_MOTOR_RF_ID 1u
