...
RTT_SCRIPT="${ROOT_DIR}/script/openocd_rtt_log.sh"

OPENOCD_CFG="${ROOT_DIR}/config/openocd/openocd_dap.cfg"
OPENOCD_RESET_RUN=1
...
选项:
  --cfg <path>         OpenOCD 配置文件 (默认: config/openocd/openocd_dap.cfg)
